...
static DWORD WINAPI
__platform_timer_wrapper(LPVOID arg)
{
	MSG msg;
...
_inline void
platform_set_timer(int seconds, platform_callback_t *f)
{
...
_inline void
platform_set_user_signal(platform_callback_t *f)
{
	/* ignore */
}
...
static void
__platform_timer_wrapper(int sig)
{
	__platform_timer_callback();
}
...
static void
__platform_user_signal_wrapper(int sig)
{
